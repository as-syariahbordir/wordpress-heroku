...
class WC_Xendit_BNI_SYARIAH_VA extends WC_Xendit_Invoice {
    public function __construct() {
        parent::__construct();

        $this->id           = 'xendit_bni_syariah';
		...
		$this->method_title = __( 'Xendit BNI Syariah VA', 'woocommerce-gateway-xendit' );
    ...
    public function init_form_fields() {
		$this->form_fields = require( WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-bni-syariah-va-settings.php' );
    }
