...
return apply_filters(
    'wc_xendit_bny_syariah_va_settings',
    array(
        'channel_name' => array(
            ...
            'placeholder' => 'Bank Transfer - BNI Syariah',
        ),
        'payment_description' => array(
            ...
            'placeholder' => 'Bayar pesanan dengan transfer bank BNI Syariah dengan virtual account melalui Xendit',
        )
    )
);
