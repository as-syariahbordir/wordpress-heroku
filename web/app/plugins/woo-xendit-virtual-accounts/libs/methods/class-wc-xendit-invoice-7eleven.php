...
class WC_Xendit_7Eleven extends WC_Xendit_Invoice {
    ...
    public function get_icon() {
        $style = version_compare(WC()->version, '2.6', '>=') ? 'style="margin-left: 0.3em; max-height: 20px;"' : '';
        $icon = '<img src="' . plugins_url('assets/images/7eleven.png', WC_XENDIT_PG_MAIN_FILE) . '" alt="Xendit" ' . $style . ' />';
