...
* WP Bootstrap Starter WordPress Theme, Copyright 2021 Author
* WP Bootstrap Starter is distributed under the terms of the GNU GPL.
...
= 3.5.3 - April 12, 2021 =
* Add more prefixes under customizer.php

= 3.5.2 - April 9, 2021 =
* Update the theme screenshot to meet the Theme Requirements
* Fix the header.php links to //

= 3.5 - March 5, 2021 =
* Update the theme screenshot to meet the Theme Requirements
* Update the style.css PHP requirements
* Remove empty files and folders
* Mention theme license in readme file
* Update the logo uploader using the WP native logo function https://codex.wordpress.org/Theme_Logo
* Fix the admin_notices function to follow the WP core UI design

= 3.4.8 - February 25, 2021 =
* Fix the warning issue on the theme under /woocommerce/cart/cart.php
