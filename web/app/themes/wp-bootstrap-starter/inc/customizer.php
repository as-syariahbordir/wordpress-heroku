...
function wp_bootstrap_starter_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section(
        'wp_bootstrap_starter_typography',
        array(
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'theme_option_setting', array(
        ...
        'section'    => 'wp_bootstrap_starter_typography',
    ...
    /*Banner*/
    $wp_customize->add_section(
        'wp_bootstrap_starter_header_image',
        array(
    ...
    $wp_customize->add_control(
        'wp_bootstrap_starter_header_img',
        array(
            'label' => __( 'Header Image', 'wp-bootstrap-starter' ),
            'section' => 'wp_bootstrap_starter_header_image',
            'type' => 'text',
            'sanitize_callback' => 'wp_bootstrap_starter_sanitize_nohtml',
        )
    );
   ...
   $wp_customize->add_section(
        'wp_bootstrap_starter_site_name_text_color',
        array(
    ...
    $wp_customize->add_section(
        'wp_bootstrap_starter_background_image',
        array(
    ...
    $wp_customize->add_control( 
        ...
        array(
            ...
            'section' => 'wp_bootstrap_starter_site_name_text_color',
    ...
    $wp_customize->get_control( 'background_image'  )->section = 'wp_bootstrap_starter_site_name_text_color';
    $wp_customize->get_control( 'background_color'  )->section = 'wp_bootstrap_starter_site_name_text_color';
...
/**
 * Live Preview of header background color
 */
